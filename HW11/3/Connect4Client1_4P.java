...
public class Connect4Client1_4P extends Thread {
	String name; // name of the player
	char gamepiece; // Gamepieces of the players ('+','*')
	Socket clientSoc;
	static boolean resultOfGame = false;

	public Connect4Client1_4P(String name, char gamepiece) {
		this.name = name;
		this.gamepiece = gamepiece;
	}

	public Connect4Client1_4P() {
	...
	public static void main(String[] args) {
		...
		while (true) {
			...
			Connect4Client1_4P playerA = new Connect4Client1_4P();
