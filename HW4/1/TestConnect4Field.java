...
public void testIt() {
	...
	dropTest(0);
	dropTest(1);
	aConnect4Field.dropPieces(12, '+');
	System.out.println(aConnect4Field);
	aConnect4Field.dropPieces(1, '*');
	System.out.println(aConnect4Field);
	System.out.println("Did the last move win: "+ aConnect4Field.didLastMoveWin());
	System.out.println("Is it a Draw: "+ aConnect4Field.isItaDraw());
